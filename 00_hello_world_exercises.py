...
#El código del ejercicio 1 imprime el texto "Hola Mundo !" por consola


# 3. Imprime tu nombre y edad en la misma lÃ­nea utilizando la funciÃ³n print.

print('Mi nombre es Daniel y tengo 26 años')

# 4. Usa la funciÃ³n type() para imprimir el tipo de dato de una cadena de texto, un nÃºmero entero y un nÃºmero decimal.

print('cadena de texto:', type('hola'))

print('numero entero:', type(2))

print('numero decimal:', type(3.5))

# 5. Escribe un comentario en varias lÃ­neas explicando quÃ© son los tipos de datos en Python.
"""
Los tipos de datos en python son clasificaciones que se utilizan para definir el valor de las variables que se
utilizan en un programa y que este puede almacenar, manipular y procesar.
...
#Primero declaramos la suma en una variable para reutilizarla de fomra sencilla y rappida
suma=5+8
#Imprimimos el resultado de la suma
print(suma)
#Y solamente queda imprimir el tipo de la suma
print(type(suma))
